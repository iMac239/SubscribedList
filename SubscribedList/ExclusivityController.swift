...
/**
    `MutuallyExclusiveQueue` is a singleton to keep track of all the in-flight
...
*/
class MutuallyExclusiveQueue {
    static let sharedMutuallyExclusiveQueue = MutuallyExclusiveQueue()
    
    private let serialQueue = dispatch_queue_create("Operations.MutuallyExclusiveQueue", DISPATCH_QUEUE_SERIAL)
